...
const main_page_1 = __importDefault(require("./main/main_page"));
const tweets_container_1 = __importDefault(require("./tweets/tweets_container"));
...
const App = () => (<div>
    ...
    <react_router_dom_1.Switch>
      <route_util_1.AuthRoute exact path='/' component={main_page_1.default}/>
      ...
      <route_util_1.ProtectedRoute exact path="/tweets" component={tweets_container_1.default}/>
