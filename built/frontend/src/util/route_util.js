...
const Auth = ({ component: Component, path, loggedIn, exact }) => (<react_router_dom_1.Route path={path} exact={exact} render={(props) => (!loggedIn ? (<Component {...props}/>) : (<react_router_dom_1.Redirect to="/"/>))}/>);
